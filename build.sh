...
case $key in
    ...
    -cxx*)
        ...
        shift # past argument
    ;;
    #todo: sanity check + add arm to arch
        -rapl)
        rapl="-DCRAPL=True"
	shift # past argument
	;;
...
if [ "$architecture" = "x86" ]; then
    ...
    $setMemoryAlignment $enableMonitoring $addTests $addBuilds $avx512 $avxtwo $sse4 $architectureFlag $compilerFlag $odroid $rapl $neon -G \
    "Unix Makefiles" ../
