...
/**
 * @file select_pl_compr_test.cpp
 * @brief Test of vectorized compressed select-operator with position-list as intermediate data output.
...
int main( void ) {
     ...
     *                 (1.1) Process inCol with uncompressed-select-operator (select_pl_uncompr.h) to compare with
     *                       compressed select operator output later in step 4
     *                 (2)   Compress inCol to delta_f to have compressed input for select_pl_compr-operator
    ...
    // (1.1) uncompr-select-operator: input -> uncompr_f, output -> position_list_f<uncompr_f>
    auto result_uncompr =
            morphstore::select<
                greater,
                sse<v128<uint64_t>>,
    ...
    // (3) Select operator: input -> delta , output -> position_list_f<uncompr_f>
    auto result_compr =
            select_pl_wit_t<
                greater,
                avx2<v256<uint64_t>>,
