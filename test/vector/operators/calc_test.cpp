...
int main( void ) {
   ...
   auto result2 = calc_binary<avx2<v256<uint64_t>>, 64,add>::apply( testDataColumnSorted, testDataColumnSorted2 );
   auto result3 = calc_binary<sse<v128<uint64_t>>, 64,add>::apply( testDataColumnSorted, testDataColumnSorted2 );
