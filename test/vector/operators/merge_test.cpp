...
int main( void ) {
   ...
   auto result1 = merge_sorted<sse<v128<uint64_t>>>::apply( testDataColumnSorted, testDataColumnSorted2 );
   auto result = merge_sorted<avx2<v256<uint64_t>>>::apply( testDataColumnSorted, testDataColumnSorted2 );
