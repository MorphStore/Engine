...
int main( void ) {
   ...
   std::tie(outGrColScalarTmp, outExtColScalar) = group<scalar<v64<uint64_t>>, uncompr_f, uncompr_f>( testDataColumnSorted1, TEST_DATA_COUNT );
...
//   print_columns(print_buffer_base::decimal, testDataColumnSorted1, outGrColScalar, outExtColScalar, "Input", "GroupIds", "GroupEx");
   std::tie(outGrColTmp, outExtCol) = group<avx2<v256<uint64_t>>, uncompr_f, uncompr_f>( testDataColumnSorted1, TEST_DATA_COUNT );
//   std::cout << "Vec Result:\n";
//   print_columns(print_buffer_base::decimal, testDataColumnSorted1, outGrCol, outExtCol, "Input", "GroupIds", "GroupEx");

   std::tie(outGrColScalar, outExtColScalar) = group<scalar<v64<uint64_t>>, uncompr_f, uncompr_f>( outGrColScalarTmp, testDataColumnSorted2, TEST_DATA_COUNT );
//   std::cout << "Scalar Result:\n";
//   print_columns(print_buffer_base::decimal, testDataColumnSorted2, outGrColScalarTmp, outGrColScalar, outExtColScalar, "Input Data", "Input GroupIds", "Result GroupIds", "Result GroupEx");
   std::tie(outGrCol, outExtCol) = group<avx2<v256<uint64_t>>, uncompr_f, uncompr_f>( outGrColTmp, testDataColumnSorted2, TEST_DATA_COUNT );
//   std::cout << "Vec Result:\n";
