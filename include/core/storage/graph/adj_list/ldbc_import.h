...
/**
 * @file ldbc_import.h
 * @brief this class reads the ldbc files and generates the graph in Adj-List format
 * @todo
*/

#ifndef MORPHSTORE_LDBC_IMPORT_ADJACENCY_LIST_H
#define MORPHSTORE_LDBC_IMPORT_ADJACENCY_LIST_H
...
namespace morphstore{
    ...
    public:
        ...
        LDBCImportAdjList(const std::string& dir){
            directory = dir;
        ...
        void generate_vertices(morphstore::AdjacencyList &graph){
        ...
        void generate_edges(morphstore::AdjacencyList &graph){
...
#endif //MORPHSTORE_LDBC_IMPORT_ADJACENCY_LIST_H
