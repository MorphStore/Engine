...
namespace morphstore{
    ...
    public:
        ...
        void addVertex(uint64_t id, uint64_t ldbc_id, int entity){
        ...
        void addEdge(uint64_t sourceID, uint64_t targetID, int relation){
        ...
        // for debugging
        void printVertexByID(uint64_t id){
