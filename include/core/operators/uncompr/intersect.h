...
#ifndef MORPHSTORE_CORE_OPERATORS_GENERAL_VECTORIZED_INTERSECT_H
#define MORPHSTORE_CORE_OPERATORS_GENERAL_VECTORIZED_INTERSECT_H
...
using namespace vectorlib;
   ...
   template<class VectorExtension>
   struct intersect_sorted_t<VectorExtension, uncompr_f, uncompr_f, uncompr_f> {
      IMPORT_VECTOR_BOILER_PLATE(VectorExtension)
...
#endif //MORPHSTORE_CORE_OPERATORS_GENERAL_VECTORIZED_INTERSECT_H