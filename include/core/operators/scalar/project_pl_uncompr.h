 ...
 * @brief Project-operator using scalar and position-list processing style.
 * @todo TODOS?
 */

#ifndef MORPHSTORE_CORE_OPERATORS_SCALAR_PROJECT_PL_UNCOMPR_H
#define MORPHSTORE_CORE_OPERATORS_SCALAR_PROJECT_PL_UNCOMPR_H
...
namespace morphstore {
    ...
    > {
        ...
        apply(
                ...
                const column< position_list_f<uncompr_f> > * const inPosCol
        ) {
...
#endif //MORPHSTORE_CORE_OPERATORS_SCALAR_PROJECT_PL_UNCOMPR_H