 ...
 * @brief Select-operator using scalar and position-list processing style.
 * @todo TODOS?
 */

#ifndef MORPHSTORE_CORE_OPERATORS_SCALAR_SELECT_PL_UNCOMPR_H
#define MORPHSTORE_CORE_OPERATORS_SCALAR_SELECT_PL_UNCOMPR_H
...
namespace morphstore {
    ...
    apply(
        ...
        // selection.
        auto outPosCol = new column< position_list_f<uncompr_f> >(
...
#endif //MORPHSTORE_CORE_OPERATORS_SCALAR_SELECT_PL_UNCOMPR_H