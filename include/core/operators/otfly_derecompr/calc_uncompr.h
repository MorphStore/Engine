...
struct compare_binary_t {
      ...
      apply(
         ...
         compare_binary_batch<scalar<v64<uint64_t>>,vector_base_t_granularity::value,Operator>::apply(inData1Ptr, inData2Ptr, (scalar<v64<uint64_t>>::mask_t *) outDataPtr, remainderCount);
