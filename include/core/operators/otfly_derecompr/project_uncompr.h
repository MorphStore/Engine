...
//
#ifndef MORPHSTORE_CORE_OPERATORS_OTFLY_DERECOMPR_UNCOMPR_H
#define MORPHSTORE_CORE_OPERATORS_OTFLY_DERECOMPR_UNCOMPR_H
...
namespace morphstore {
   ...
   struct project_t_processing_unit {
      ...
      MSV_CXX_ATTRIBUTE_FORCE_INLINE static vector_t apply(
         ...
         return (vectorlib::gather<t_vector_extension, vector_size_bit::value, sizeof(base_t)>(p_DataPtr, p_PosVector));
      }
   };
   ...
   struct project_t_batch {
      ...
      MSV_CXX_ATTRIBUTE_FORCE_INLINE static void apply(
         ...
         for(size_t i = 0; i < p_Count; ++i) {
            vector_t posVector = vectorlib::load<t_vector_extension, vectorlib::iov::ALIGNED, vector_size_bit::value>(p_PosPtr);
            vector_t lookupVector =
               project_t_processing_unit<t_vector_extension>::apply(
                  p_DataPtr,
                  posVector
               );
            vectorlib::store<t_vector_extension, vectorlib::iov::ALIGNED, vector_size_bit::value>(p_OutPtr, lookupVector);
...
#endif //MORPHSTORE_CORE_OPERATORS_OTFLY_DERECOMPR_UNCOMPR_H
