...
#ifndef MORPHSTORE_CORE_OPERATORS_GENERAL_VECTORIZED_GROUP_UNARY_COMPR_H
#define MORPHSTORE_CORE_OPERATORS_GENERAL_VECTORIZED_GROUP_UNARY_COMPR_H
...
namespace morphstore {
   ...
   >
   struct group_unary_processing_unit_wit {
...
//         );
         ...
         typename group_unary_processing_unit_wit<
            VectorExtension,
            DataStructure,
            OutFormatGroupIds,
            OutFormatGroupExtents
         ...
         decompress_and_process_batch<
            VectorExtension,
            InFormatData,
            group_unary_processing_unit_wit,
            DataStructure,
            OutFormatGroupIds,
            OutFormatGroupExtents
         >::apply(
   ...
   > group_vec(
      ...
      return group_unary_wit_t<VectorExtension,
         hash_map<
            VectorExtension,
            multiply_mod_hash,
...
#endif //MORPHSTORE_CORE_OPERATORS_GENERAL_VECTORIZED_GROUP_UNARY_COMPR_H
