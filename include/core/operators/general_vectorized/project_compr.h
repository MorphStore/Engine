...
// //     Scalable
//     MSV_CXX_ATTRIBUTE_FORCE_INLINE static void apply(
//             vector_t p_Data, state_t & p_State, int element_count
//     ) {
//         p_State.m_Wit.write(p_State.m_Rra.get(p_Data, element_count), element_count);
//     }
// };
...
//                         // std::cout << inPosCountLogScalarRemainder << " Elemente" << std::endl;

//                         typename project_processing_unit_wit<
//                                 t_ve, uncompr_f, t_in_data_f
//                         >::state_t witUncomprState(outDataAppendUncompr, inData);
...
//                                 t_in_data_f
//                         >::apply(
//                                 inPos, inPosCountLogScalarRemainder, witUncomprState
//                         );

//                         std::tie(std::ignore, std::ignore, outData) = witUncomprState.m_Wit.done();
...
//         // std::cout << "OutDataCountLog" << outDataCountLog << std::endl;
//         // std::cout <<  "outData" << outData << std::endl;
//         // std::cout <<  "outDataSizeComprByte" << outDataSizeComprByte << std::endl;
...
// Scalable w/ direct call of core operator
/**********************************************************************************************
 * Copyright (C) 2019 by MorphStore-Team                                                      *
 *                                                                                            *
 * This file is part of MorphStore - a compression aware vectorized column store.             *
...
public:
    ...
    static const column<t_out_data_f> * apply(
        ...
        //     std::cout << "Uncompr vec " << inPosSizeUncomprVecByte << std::endl;
            decompress_and_process_batch<
                    t_ve,
                    uncompr_f,
                    project_processing_unit_wit,
            ...
            if(inSizeScalarRemainderByte) {
                ...
                // std::cout << "Remainder " << inPosCountLogScalarRemainder << std::endl;
                // std::cout << "RemainderByte " << inSizeScalarRemainderByte << std::endl;
                ...
                // for(unsigned i = 0; i < inPosCountLogScalarRemainder;i++
                // ) {
                //         std::cout << tmpIn[i] << ";";
                // }
                // std::cout << std::endl;
    ...
    static const column<t_out_data_f> * apply(
        ...
        //     std::cout << "Uncompr vec " << inPosSizeUncomprVecByte << std::endl;
            ...
            if(inSizeScalarRemainderByte) {
                ...
                const base_t * inBase = reinterpret_cast<const base_t *>(inPos);
                ...
                >::apply(
                        ...
                        >(inBase, inPosCountLogScalarRemainder),
                        witUncomprState, inPosCountLogScalarRemainder
                );
