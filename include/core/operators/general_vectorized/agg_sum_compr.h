            ...
            *outPtr = agg_sum_processing_unit_wit<VectorExtension>::finalize( witState );
            ...
            base_t result = 0;
               if( inSizeScalarRemainderByte ) {
                  ...
                  result = agg_sum_processing_unit_wit<VectorExtension>::finalize( witState );
               } else {
                  result = agg_sum_processing_unit_wit<VectorExtension>::finalize( witState );
               }
            *outPtr = result;
...
//  Scalable w/ 2 calls of vector-recursive intrinsics
// /**********************************************************************************************
//  * Copyright (C) 2019 by MorphStore-Team                                                      *
//  *                                                                                            *
//  * This file is part of MorphStore - a compression aware vectorized column store.             *
...
//                   witUncomprState
//                );
//                result =  result + agg_sum_processing_unit_wit<VectorExtension>::finalize( witUncomprState, convert_size<uint8_t, uint64_t>(inSizeScalarRemainderByte) );
//             }
//             *outPtr = result;
//          }
//          outCol->set_meta_data(
