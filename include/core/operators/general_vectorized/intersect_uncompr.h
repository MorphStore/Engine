...
using namespace vectorlib;
  ...
  struct call_scalar_batch_intersect_sorted<32, T>{
   ...
   template<typename T>
   struct call_scalar_batch_intersect_sorted<16, T>{
      ...
      static size_t call(  base_t  const * p_Data1Ptr,//left
         ...
         typename intersect_sorted_processing_unit<scalar<v16<T>>>::state_t scalarState;
         return intersect_sorted_batch<scalar<v16<T>>>::apply(p_Data1Ptr, p_Data2Ptr, p_OutPtr, p_CountData1,p_CountData2, scalarState);
      }
   };

   template<typename T>
   struct call_scalar_batch_intersect_sorted<8, T>{
      ...
      static size_t call(  base_t  const * p_Data1Ptr,//left
         ...
         typename intersect_sorted_processing_unit<scalar<v8<T>>>::state_t scalarState;
         return intersect_sorted_batch<scalar<v8<T>>>::apply(p_Data1Ptr, p_Data2Ptr, p_OutPtr, p_CountData1,p_CountData2, scalarState); 
      }
   };
