...
struct select_t<t_op, vectorlib::sse<vectorlib::v128<uint64_t>>, uncompr_f, uncompr_f> {
    static
...
template<template<typename> class t_op>
struct select_t<t_op, vectorlib::avx2<vectorlib::v256<uint64_t>>, uncompr_f, uncompr_f> {
    static
    const column<uncompr_f> * apply(
            const column<uncompr_f> * const inDataCol,
            const uint64_t val,
