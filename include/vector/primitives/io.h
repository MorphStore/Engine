...
namespace vectorlib {
   ...
   template<class VectorExtension, iov IOVariant, int IOGranularity>
   void
   store(typename VectorExtension::base_t * a,  typename VectorExtension::vector_t b, int element_count ) {
       io<VectorExtension, IOVariant, IOGranularity>::store( a, b, element_count );
       return;
   }
...
//    };
   ...
   gather(typename VectorExtension::base_t const * const a,  typename VectorExtension::vector_t b, 
   int element_count) {
      return gather_t<VectorExtension, IOGranularity, Scale>::apply( a, b, element_count );
   }
