...
namespace vector{
   template<>
   struct add<scalar<uint64_t>/*, 64*/> {
      MSV_CXX_ATTRIBUTE_FORCE_INLINE
      static
      typename scalar<uint64_t>::vector_t
      apply(
         typename scalar<uint64_>::vector_t const & p_vec1,
         typename scalar<uint64_>::vector_t const & p_vec2
      ){
   ...
   template<>
   struct sub<scalar<uint64_t>/*, 64*/> {
      MSV_CXX_ATTRIBUTE_FORCE_INLINE
      static
      typename scalar<uint64_t>::vector_t
      apply(
         typename scalar<uint64_t>::vector_t const & p_vec1,
         typename scalar<uint64_t>::vector_t const & p_vec2
      ){
   ...
   template<>
   struct hadd<scalar<uint64_t>/*, 64*/> {
      MSV_CXX_ATTRIBUTE_FORCE_INLINE
      static
      typename scalar<uint64_t>::base_t
      apply(
         typename scalar<uint64_t>::vector_t const & p_vec1
      ){
