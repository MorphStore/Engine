...
namespace vectorlib {
   ...
   struct logic<scalar<v64<T>>, 64/*scalar<v64<T>>::vector_helper_t::size_bit::value*/ > {
      ...
      bitwise_and( typename scalar<v64<T>>::mask_t p_In1, typename scalar<v64<T>>::mask_t p_In2) {
         return (p_In1 & p_In2 );
      }
      ...
      static
      typename scalar<v64<T>>::mask_t
      bitwise_or( typename scalar<v64<T>>::mask_t p_In1, typename scalar<v64<T>>::mask_t p_In2) {
         return (p_In1 | p_In2 );
      }
   };
