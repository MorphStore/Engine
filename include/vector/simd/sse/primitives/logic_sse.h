...
namespace vectorlib {
   ...
   struct logic<sse<v128<T>>, sse<v128<T>>::vector_helper_t::size_bit::value > {
      ...
      bitwise_and( typename sse<v128<T>>::mask_t p_In1, typename sse<v128<T>>::mask_t p_In2) {
         return ( p_In1 & p_In2 );
      }
      ...
      static
      typename sse<v128<T>>::mask_t
      bitwise_or( typename sse<v128<T>>::mask_t p_In1, typename sse<v128<T>>::mask_t p_In2) {
         return ( p_In1 | p_In2 );
      }
   };
