...
io_load_ran_simd += 1;
         ...
         __m512i d_vec_1 = _mm512_i32gather_epi32(p_vec_1,reinterpret_cast<const int *> (p_DataPtr), p_vec_1, 1);
         __m512i d_vec_2 = _mm512_i32gather_epi32(p_vec_2,reinterpret_cast<const int *> (p_DataPtr), p_vec_2, 1);
         __m512i d_vec_3 = _mm512_i32gather_epi32(p_vec_3,reinterpret_cast<const int *> (p_DataPtr), p_vec_3, 1);
         __m512i d_vec_4 = _mm512_i32gather_epi32(p_vec_4,reinterpret_cast<const int *> (p_DataPtr), p_vec_4, 1);
...
io_write_ran_simd += 1;
    ...
    template<typename T, int IOGranularity>
    struct io<avx512<v128<T>>,iov::UNALIGNED, 32> {
    template< typename U = T, typename std::enable_if< std::is_integral< U >::value, int >::type = 0 >
      MSV_CXX_ATTRIBUTE_FORCE_INLINE
      static void
      compressstore( U * p_DataPtr,  avx512< v128< int > >::vector_t p_vec, int mask ) {
...
io_write_ran_simd += 1;
    ...
    template<typename T, int IOGranularity>
    struct io<avx512<v128<T>>,iov::UNALIGNED, 16> {
    template< typename U = T, typename std::enable_if< std::is_integral< U >::value, int >::type = 0 >
      MSV_CXX_ATTRIBUTE_FORCE_INLINE
      static void
      compressstore( U * p_DataPtr,  avx512< v128< int > >::vector_t p_vec, int mask ) {
...
#endif
         trace( "[VECTOR] - Store masked unaligned integer values to memory" );
         _mm_mask_compressstoreu_epi16((void *)p_DataPtr,mask, p_vec);
         return ;
      }
    };
    template<typename T, int IOGranularity>
    struct io<avx512<v128<T>>,iov::UNALIGNED, 8> {
    template< typename U = T, typename std::enable_if< std::is_integral< U >::value, int >::type = 0 >
      MSV_CXX_ATTRIBUTE_FORCE_INLINE
      static void
      compressstore( U * p_DataPtr,  avx512< v128< int > >::vector_t p_vec, int mask ) {
...
#endif
         trace( "[VECTOR] - Store masked unaligned integer values to memory" );
         _mm_mask_compressstoreu_epi8((void *)p_DataPtr,mask, p_vec);
         return ;
      }
    };
*/
