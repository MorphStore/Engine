...
namespace vectorlib {
   ...
   compressstore( U * p_DataPtr,  avx512< v512< int > >::vector_t p_vec, int mask ) {
      TALLY_IO_WRITE_RAN_SIMD
      trace( "[VECTOR] - Store masked unaligned integer values to memory" );
      _mm512_mask_compressstoreu_epi16((void *)p_DataPtr, mask,p_vec);  //NEEDS: CPUID Flag: AVX512_VBMI2
      return ;
   }};
   template<typename T>
   ...
   compressstore( U * p_DataPtr,  avx512< v512< int > >::vector_t p_vec, int mask ) {
      TALLY_IO_WRITE_RAN_SIMD
      trace( "[VECTOR] - Store masked unaligned integer values to memory" );
      _mm512_mask_compressstoreu_epi8((void *)p_DataPtr, mask,p_vec);   //NEEDS: CPUID Flag: AVX512_VBMI2
      return ;
   }};
