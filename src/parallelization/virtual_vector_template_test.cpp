...
int main() {
    ...
    using vv_core     = vv<VectorBuilder<cpu_openmp, 1, seq, 1, baseVectorExtension> >;
    using vv_batch    = vv<VectorBuilder<cpu_openmp, 1, seq, 1, vv_core            > >;
    using vv_operator = vv<VectorBuilder<cpu_openmp, 1, seq, 1, vv_batch           > >;
