...
std::vector<typename t_varex_t::variant_t> make_variants() {
    return {
        ...
        MAKE_VARIANT(avx512<v512<uint64_t>>, SINGLE_ARG(group_simple_f<8, uint64_t, 64>), t_Bw),
        ...
        MAKE_VARIANT(avx2<v256<uint64_t>>, SINGLE_ARG(group_simple_f<4, uint64_t, 32>), t_Bw),
        ...
        MAKE_VARIANT(sse<v128<uint64_t>>, SINGLE_ARG(group_simple_f<2, uint64_t, 16>), t_Bw),
        ...
        MAKE_VARIANT(scalar<v64<uint64_t>>, SINGLE_ARG(group_simple_f<1, uint64_t, 8>), t_Bw),
